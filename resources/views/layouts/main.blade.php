...
<head>
  ...
  <style>
    ...
    .sidebar {
      ...
      position: fixed;
      height: 100%;
      background: linear-gradient(180deg, #151616 0%, #3a4144 100%);
      color: white;
    ...
    .sidebar a:hover { background-color: #858481; color: #b2d1f0; }
    .content { margin-left: 250px; padding: 20px; background-color: #FAFAFA; }
    .navbar { background: linear-gradient(90deg, #84a4b3 0%, #e0ddbf 50%, #0f151b 100%); border: none; }
    .navbar-brand { color: #242f3a !important; font-weight: bold; }
  </style>
</head>
<body>
  <div class="sidebar">
